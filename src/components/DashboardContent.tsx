  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        ...
        <div className="bg-card/60 backdrop-blur-sm rounded-xl p-4 border border-border/50 text-center">
          <Activity className="h-6 w-6 text-chart-4 mx-auto mb-2" />
          <div className="text-2xl font-bold text-foreground mb-1">
        ...
        <div className="bg-card/60 backdrop-blur-sm rounded-xl p-4 border border-border/50 text-center">
          <Clock className="h-6 w-6 text-chart-5 mx-auto mb-2" />
          <div className="text-2xl font-bold text-foreground mb-1">
        ...
        <div className="bg-card/60 backdrop-blur-sm rounded-xl p-4 border border-border/50 text-center">
          <Database className="h-6 w-6 text-chart-3 mx-auto mb-2" />
          <div className="text-2xl font-bold text-foreground mb-1">
        ...
        <div className="bg-card/60 backdrop-blur-sm rounded-xl p-4 border border-border/50 text-center">
          <Droplets className="h-6 w-6 text-chart-2 mx-auto mb-2" />
          <div className="text-2xl font-bold text-foreground mb-1">
        ...
        <div className="space-y-6">
          <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-6 border border-border/50 shadow-xl">
            ...
            {latestMeal ? (
              ...
              <div className="border-2 border-dashed border-muted/50 rounded-lg p-8 text-center">
