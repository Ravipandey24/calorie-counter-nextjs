              ...
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="flex items-center gap-2 h-10 px-3 rounded-full hover:bg-accent/80 transition-all duration-300"
                    >
                  ...
                  <DropdownMenuContent
                    className="w-64 bg-card/90 backdrop-blur-sm border-border/50"
                    align="end"
                    forceMount
                  >
